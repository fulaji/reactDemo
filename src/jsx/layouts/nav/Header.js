...
import { loginRemoveToken } from "../../../stores/auth/actions";
import { fetchAllActivities } from "../../../stores/properties/actions";
                ...
                <Dropdown.Menu align="right" className="mt-2">
                  <PerfectScrollbar className="widget-media dz-scroll p-3 height380 ps">
                    ...
                    {props.activities.map((activity, key) => (
                            <li>
                                <Link className="has-arrow ai-icon" to={`/property-details/${activity.property_id}/${activity.id}`} aria-expanded="false">
                                  <div className="timeline-panel">
                                    <div className="media mr-2 media-info"><i class="las la-bullhorn"></i></div>
                                    <div className="media-body">
                                      <h6 className="mb-1">New Voicemail from {activity.owner}</h6>
                      ...
                      { props.activities.length > 0
                        ...
                        :(  <li>
                                <div className="timeline-panel">
                                  {/* <div className="media mr-2 media-info"><i class="las la-bullhorn"></i></div> */}
                                  <div className="media-body">
                                    <h6 className="mb-1">No Voicemail Found</h6>
              ...
              <Dropdown className="nav-item dropdown header-profile ml-sm-4 ml-2">
                ...
                >
                  <div className="header-info">
                    ...
                    <p className="fs-12 mb-0">{props.profile?.role}</p>
                  </div>
                  {/* <img src={profile} width={20} alt="" /> */}
                  <div style={{width: 30, height: 30, borderRadius: "50%", backgroundColor: "#3B4CB8"}}>
                    <p style={{textAlign: "center", color: "#fff", textTransform: "uppercase"}}>{props.profile?.name?.substring(0,1)}</p>
                  </div>
                </Dropdown.Toggle>
                <Dropdown.Menu align="right" className="mt-2">
                  ...
                  <p 
                    ...
                    onClick={()=> props.loginRemoveToken()}
                  >
                    <svg
                      id="icon-logout"
                      xmlns="http://www.w3.org/2000/svg"
...
const mapStateToProps = (state) => ({
  ...
  activities: state.properties.allActivity,
});
