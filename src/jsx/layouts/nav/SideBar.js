      ...
      <div className="deznav">
        <PerfectScrollbar className="deznav-scroll">
          ...
          <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="/property-list" aria-expanded="false">
            ...
            {/*<li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
              ...
              <ul aria-expanded="false">
                ...
                <li>
                  <Link
                    className={`${path === "property-list" ? "mm-active" : ""}`}
                    to="/property-list"
                  >
                    Property List
                  </Link>
            ...
            <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="/app-calender/all" aria-expanded="false">
                <i className="flaticon-381-calendar"></i>
                <span className="nav-text">Calendar</span>
              </Link>
            </li>
            <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="/user-list" aria-expanded="false">
            ...
            <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="/messages" aria-expanded="false">
            ...
            <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="/ivr" aria-expanded="false">
                <i class="las la-sliders-h"></i>
                <span className="nav-text">Phone Switch</span>
              </Link>
            </li>

            <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="/campaign" aria-expanded="false">
          ...
          <div className="copyright">
            <p className="fs-14 font-w200">
              <strong className="font-w400">My Equity Finder</strong> ©All Rights
              Reserved
            </p>
            {/* <p>by DexignZone</p> */}
          </div>
