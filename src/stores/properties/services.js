...
export function _getNumberProperty(formData, token) {
  return new Promise((resolve, reject) => {
    axios
    .post(`${API_URL}Message/checknumber`, formData, {
      headers:{
        Authorization: token
      }
    })
...
export function _fetchStats(token) {
  return new Promise((resolve, reject) => {
    axios
    .get(`${API_URL}stats/`, {
      headers:{
...
export function _fetchAllActivities(token) {
  return new Promise((resolve, reject) => {
    axios
    .get(`${API_URL}activities/notification`, {
      headers:{
        Authorization: token
      }
    })
...
export function _fetchOneActivities(id, token) {
  return new Promise((resolve, reject) => {
    axios
    .get(`${API_URL}activities/notificationone?voice_id=${id}`, {
      headers:{
        Authorization: token
      }
    })
